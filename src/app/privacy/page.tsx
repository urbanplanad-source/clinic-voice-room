const sections = [
  ...
  },
  {
    title: "2. 음성 및 번역 데이터",
    body:
      "통역 기능을 제공하기 위해 직원 또는 환자의 음성이 서버와 OpenAI API로 전송될 수 있습니다. 원본 음성 파일은 서비스 운영 목적으로 영구 저장하지 않으며, 상담 종료 시 실시간 전달에 사용된 임시 메시지는 삭제 대상입니다."
  },
  {
    title: "3. 제3자 처리",
    body:
  ...
  },
  {
    title: "5. 보관 및 삭제",
    body:
      "직원 로그인 세션, 병원 사용량 메타데이터, 통역방 운영에 필요한 최소 데이터는 서비스 제공과 운영 확인을 위해 필요한 기간 동안 보관될 수 있습니다. 통역방 종료 시 실시간 상담 메시지는 삭제 또는 만료 처리됩니다."
  },
  {
    title: "6. 문의",
    body:
