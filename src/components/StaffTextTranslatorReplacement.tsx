    ...
    <div className="flex min-h-[calc(100dvh-104px)] flex-col space-y-3 md:space-y-4">
      ...
      {shouldShowReplySuggestion ? (
        <section className="overflow-hidden rounded-lg border border-line bg-white shadow-soft">
          ...
          ) : suggestedReplyKo && translatedReply ? (
                ...
                <div className="mb-2 flex items-center justify-between gap-3">
                  ...
                  <div className="flex shrink-0 gap-1">
                    <button
                      type="button"
                      onClick={() =>
                        speak(translatedReply, sourceLanguage)
                      }
                      className="grid h-9 w-9 place-items-center rounded-lg text-slate-400 transition hover:bg-slate-50 hover:text-ink"
                      aria-label="예상 답변 듣기"
                      title="예상 답변 듣기"
                    >
                      <Volume2 size={19} />
