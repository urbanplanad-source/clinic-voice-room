...
```text
android-staff-app/app/build/outputs/apk/field/medivoice-0.3.16-field.apk
```
...
- Google Play field APK: `android-staff-app/app/build/outputs/apk/field/medivoice-0.3.16-field.apk`
- Google Play release AAB filename after bundle build: `android-staff-app/app/build/outputs/bundle/release/medivoice-0.3.16-release.aab`
...
- The v0.3.16 field APK is non-debuggable but still debug-signed for field testing. A signed release build and staff-device provisioning are still needed before production distribution.
